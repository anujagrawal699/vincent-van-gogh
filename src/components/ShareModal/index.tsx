      ...
      {open &&
        createPortal(
          <div className="fixed inset-0 z-[100] overflow-y-auto">
            <div
              className="fixed inset-0 z-10 bg-black/30 pointer-events-none"
              aria-hidden="true"
            />
            <div className="relative z-20 flex min-h-full items-end sm:items-center justify-center p-0 sm:p-4">
              <div
                role="dialog"
                aria-modal="true"
                aria-label="Share your weekend"
                className="w-full max-w-5xl rounded-t-xl sm:rounded-xl bg-white p-4 sm:p-5 shadow-lg pointer-events-auto max-h-[95vh] overflow-y-auto"
              >
