          ...
          <div className="absolute right-0 top-full mt-1 z-20 w-80 rounded-lg border bg-white shadow-lg overflow-hidden">
            <div className="p-3 border-b">
              ...
              <p className="text-xs text-gray-500 mt-1">
                Each theme features a Van Gogh masterpiece
              </p>
            </div>
            ...
            <div className="max-h-96 overflow-y-auto" role="listbox">
              {allThemes.map((t) => {
                const painting =
                  t.id !== "default" ? getVanGoghPainting(t.id) : null;
                const isSelected =
                  theme?.id === t.id || (!theme && t.id === "default");
                return (
                  <button
                    key={t.id}
                    role="option"
            ...
            {(currentPainting || !theme) && (
              <div className="p-3 bg-gray-50 border-t">
                <div className="text-xs text-gray-600">
                  ...
                  by Vincent van Gogh (
                  {currentPainting ? currentPainting.year : "1889"})
                </div>
              </div>
            )}
          </div>
