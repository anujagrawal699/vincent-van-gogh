...
export const themes: WeekendTheme[] = [
  ...
  },
  {
    ...
    suggestedActivities: ['friends-001', 'date-001', 'board-001', 'karaoke-001'],
  ...
  },
  {
    ...
    suggestedActivities: ['yoga-001', 'meditation-001', 'hike-001', 'sunset-001'],
...
export const getThemeById = (id: string) => themes.find(t => t.id === id) || null;
